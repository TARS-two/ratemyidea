  ...
  return (
    <div className="min-h-screen grid-bg">
      ...
      {showShareModal && result && (
        ...
        >
          <div className="bg-[var(--surface)] border border-white/10 rounded-3xl w-full max-w-xl overflow-hidden animate-fade-up">
            {/* Header */}
            ...
            <div className="px-4 pb-5 grid grid-cols-5 gap-2">
              <button
                onClick={handleDownloadImage}
                className="flex flex-col items-center gap-1.5 py-3 bg-[var(--surface-light)] border border-white/10 rounded-xl hover:border-[var(--electric)]/50 transition-all cursor-pointer"
              >
                <svg className="w-5 h-5 text-[var(--text-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5m0 0l5-5m-5 5V3" /></svg>
              ...
              >
                {shared ? (
                  ...
                  <svg className="w-5 h-5 text-[var(--text-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1" /></svg>
                )}
                <span className="text-[10px] text-[var(--text-muted)]">{shared ? "✓" : (lang === "es" ? "Copiar" : "Copy")}</span>
              </button>
              <button
                onClick={handleShareTwitter}
                className="flex flex-col items-center gap-1.5 py-3 bg-[var(--surface-light)] border border-white/10 rounded-xl hover:border-[var(--electric)]/50 transition-all cursor-pointer"
              >
                <svg className="w-5 h-5 text-[var(--text-primary)]" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                <span className="text-[10px] text-[var(--text-muted)]">X</span>
              </button>
              <button
