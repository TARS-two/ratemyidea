...
assert(home.includes('Share score card') && home.includes('Download score card image') && home.includes('Copy link and text'), 'Score share-card actions should keep accessible full labels while showing compact button text.');
...
assert(home.includes('max-w-sm gap-2 sm:grid-cols-3') && home.includes('px-3 py-2 text-xs'), 'Score card share buttons should be compact relative to the idea name.');
