...
assert(home.includes('Ocultar idea') && home.includes('Hide idea') && !home.includes('Comparte una versión limpia'), 'Score share card should use a simple hide-idea toggle and avoid explanatory copy bloat.');
assert(home.includes('Comparte tu score') && home.includes('Share your score'), 'Score card should invite sharing directly in the first score section.');
